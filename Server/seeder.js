...
var generateCategories =
  require("./fake-data/category.FakeData").generateCategories;
...
var Seeder = /** @class */ (function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            if (!generator) {
              console.error(
                "No generator found for model: ".concat(model.modelName)
              );
              return [2 /*return*/];
            }
            data = generator(num);
              ...
              model
                ...
                .catch(function (err) {
                  ...
                  console.error(
                    "".concat(
                      (_b =
                        (_a = err.writeErrors) === null || _a === void 0
                          ? void 0
  ...
  Seeder.prototype.FillRefrrences = function (
    model,
    FieldToBeFilled,
    data,
    referenceData
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            schema = model.schema;
            referencePaths = Object.keys(schema.paths).filter(function (path) {
              return path === FieldToBeFilled;
            });
            ...
            savePromises = data.map(function (doc, index) {
              ...
              referencePaths.forEach(function (referencePath) {
                ...
                var referenceId = new mongodb_1.ObjectId(
                  referenceData[index]._id
                );
          ...
          case 1:
            ...
            console.log(
              ""
                ...
                .concat(
                  model.modelName,
                  " have been filled with reference data."
                )
            );
            return [2 /*return*/];
        }
...
function AllInOrder() {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, SeederOvbject.GenerateFakeData(Book, 10)];
        case 1:
          _a.sent();
