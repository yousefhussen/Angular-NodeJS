                    ...
                    case 0:
                        ...
                        savePromises = data.map(function (doc, index) {
                            ...
                            referencePaths.forEach(function (referencePath) {
                                ...
                                var referenceId = referenceData[index]._id;
...
function AllInOrder() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, SeederOvbject.GenerateFakeData(Book, 10)];
                case 1:
                    _a.sent();
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, SeederOvbject.GenerateFakeData(Category, 10)];
                case 4:
                    _a.sent();
